...
import com.github.franckyi.ibeeditor.client.editor.gui.standard.entry.*;
import com.github.franckyi.ibeeditor.client.editor.gui.standard.entry.item.*;
...
public final class EntryMVC implements MVC<EntryModel, EntryView, EntryController<EntryModel, EntryView>> {
    ...
    public EntryView setup(EntryModel model) {
        switch (model.getType()) {
            ...
            case SELECTION:
                return MVC.createViewAndBind((SelectionEntryModel) model, SelectionEntryView::new, SelectionEntryController::new);
            ...
            case INVENTORY_ITEM:
                return MVC.createViewAndBind(((InventoryItemEntryModel) model), InventoryItemEntryView::new, InventoryItemEntryController::new);
            default:
