...
import com.github.franckyi.ibeeditor.client.editor.gui.standard.entry.SelectionEntryController;
...
public class PotionSelectionEntryController extends SelectionEntryController<PotionSelectionEntryModel, PotionSelectionEntryView> {
    ...
    private void updatePotionItem() {
        view.getPotionView().setItem(TagHelper.createPotionItemWithColor(ResourceLocation.tryParse(model.getValue()), model.getCustomColor()));
    }
