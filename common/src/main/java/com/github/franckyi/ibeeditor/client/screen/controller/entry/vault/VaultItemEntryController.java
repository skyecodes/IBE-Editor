...
public class VaultItemEntryController extends EntryController<VaultItemEntryModel, VaultItemEntryView> {
    ...
    public void bind() {
        ...
        view.getOpenNBTEditorButton().onAction(() -> ModScreenHandler.openNBTEditorScreen(model.getItemStack().save(new CompoundTag()),
                tag -> model.setItemStack(ItemStack.of(tag)), null, true));
        view.getOpenSNBTEditorButton().onAction(() -> ModScreenHandler.openSNBTEditorScreen(model.getItemStack().save(new CompoundTag()),
                tag -> model.setItemStack(ItemStack.of(tag)), null, true));*/
    }
}
