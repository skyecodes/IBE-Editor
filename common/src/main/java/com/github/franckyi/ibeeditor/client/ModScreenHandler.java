...
import com.github.franckyi.ibeeditor.client.config.gui.ConfigEditorMVC;
import com.github.franckyi.ibeeditor.client.config.gui.ConfigEditorModel;
import com.github.franckyi.ibeeditor.client.editor.gui.nbt.NBTEditorMVC;
import com.github.franckyi.ibeeditor.client.editor.gui.nbt.NBTEditorModel;
import com.github.franckyi.ibeeditor.client.editor.gui.snbt.SNBTEditorMVC;
import com.github.franckyi.ibeeditor.client.editor.gui.snbt.SNBTEditorModel;
...
import com.github.franckyi.ibeeditor.client.editor.gui.standard.StandardEditorMVC;
import com.github.franckyi.ibeeditor.client.util.ScreenScalingManager;
import com.github.franckyi.ibeeditor.client.util.selection.gui.color.ColorSelectionScreenMVC;
...
import com.github.franckyi.ibeeditor.client.util.selection.gui.list.ListSelectionScreenMVC;
import com.github.franckyi.ibeeditor.client.util.selection.gui.list.ListSelectionScreenModel;
...
import com.github.franckyi.ibeeditor.client.vault.gui.VaultMVC;
...
public final class ModScreenHandler {
    ...
    public static void openVaultScreen() {
        openScaledScreen(mvc(VaultMVC.INSTANCE, new VaultModel()));
    }

    public static void openVaultSelectionScreen(VaultItemType type, Consumer<VaultItemModel> action) {
        openScaledScreen(mvc(VaultMVC.INSTANCE, new VaultModel(type, action)));
    }
    ...
    private static void openScaledScreen(Node root) {
        try {
            ...
            Minecraft.getInstance().player.displayClientMessage(ModTexts.ERROR_GENERIC, false);
        }
    }
