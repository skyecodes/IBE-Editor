...
public final class IBEEditorNetwork {
    ...
    public static void init() {
        ...
        network().registerServerHandler(OPEN_ENTITY_EDITOR_REQUEST, i++, OpenEntityEditorRequestPacket.class, OpenEntityEditorRequestPacket::new, PacketHandler::requestOpenEntityEditor);
        network().registerClientHandler(OPEN_ENTITY_EDITOR_RESPONSE, i++, OpenEntityEditorResponsePacket.class, OpenEntityEditorResponsePacket::new, PacketHandler::openEntityEditor);
    }
}
