...
import com.github.franckyi.ibeeditor.client.editor.gui.standard.entry.item.HideFlagEntryModel;
...
public class ItemHideFlagsCategoryModel extends ItemCategoryModel {
    ...
    public enum HideFlag {
        ...
        public MutableComponent getName() {
            return ModTexts.modTranslated(name().toLowerCase(Locale.ROOT));
        }
