...
import com.github.franckyi.ibeeditor.client.editor.gui.standard.entry.AddListEntryEntryModel;
...
public abstract class CategoryModel implements Model {
    ...
    protected int getEntryListStart() {
        return -1;
    }

    protected int getEntryListIndex(int index) {
        return getEntryListStart() + index;
    }

    protected int getEntryListSize() {
