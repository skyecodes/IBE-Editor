...
public abstract class AbstractForgeVanillaListNodeRenderer<N extends ListNode<E>, E, T extends AbstractForgeVanillaListNodeRenderer.NodeEntry<N, E, T>> extends AbstractSelectionList<T> implements ForgeVanillaDelegateRenderer {
    ...
    public boolean preRender(IMatrices matrices, int mouseX, int mouseY, float delta) {
        ...
        super.render((PoseStack) matrices, mouseX, mouseY, delta); // doing the actual rendering here to not hide the other elements
        return res;
    }
    ...
    protected abstract static class NodeEntry<N extends ListNode<E>, E, T extends NodeEntry<N, E, T>> extends AbstractSelectionList.Entry<T> {
