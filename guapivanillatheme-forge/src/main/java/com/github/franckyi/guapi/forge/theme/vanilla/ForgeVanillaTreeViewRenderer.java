...
public class ForgeVanillaTreeViewRenderer<E extends TreeView.TreeItem<E>> extends AbstractForgeVanillaListNodeRenderer<TreeView<E>, E, ForgeVanillaTreeViewRenderer.NodeEntry<E>> {
    ...
    protected static class NodeEntry<E extends TreeView.TreeItem<E>> extends AbstractForgeVanillaListNodeRenderer.NodeEntry<TreeView<E>, E, NodeEntry<E>> {
        private static final IIdentifier TREE_VIEW_WIDGETS = IIdentifier.of("guapivanillatheme", "textures/gui/tree_view_widgets.png");
