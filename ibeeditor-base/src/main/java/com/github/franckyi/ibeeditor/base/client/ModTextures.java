...
public class ModTextures {
    ...
    public static final IIdentifier BYTE_ARRAY_TAG = gui("byte_array_tag");
    public static final IIdentifier BYTE_ARRAY_TAG_ADD = gui("byte_array_tag_add");
    public static final IIdentifier BYTE_TAG = gui("byte_tag");
    ...
    public static final IIdentifier COMPOUND_TAG = gui("compound_tag");
    ...
    public static final IIdentifier LIST_TAG = gui("list_tag");
    public static final IIdentifier LIST_TAG_ADD = gui("list_tag_add");
    public static final IIdentifier LONG_ARRAY_TAG = gui("long_array_tag");
    public static final IIdentifier LONG_ARRAY_TAG_ADD = gui("long_array_tag_add");
    public static final IIdentifier LONG_TAG = gui("long_tag");
    ...
    public static final IIdentifier SHORT_TAG = gui("short_tag");
    public static final IIdentifier SHORT_TAG_ADD = gui("short_tag_add");
    public static final IIdentifier STRING_TAG = gui("string_tag");
