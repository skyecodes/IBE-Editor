...
public final class ClientCache {
    ...
    private static IIdentifier getEnchantmentTypeItem(IEnchantment e) {
        return switch (e.getTarget()) {
            case IEnchantment.TARGET_ARMOR, IEnchantment.TARGET_WEARABLE -> IIdentifier.of("minecraft:iron_chestplate");
            case IEnchantment.TARGET_ARMOR_FEET -> IIdentifier.of("minecraft:diamond_boots");
            case IEnchantment.TARGET_ARMOR_LEGS -> IIdentifier.of("minecraft:diamond_leggings");
            case IEnchantment.TARGET_ARMOR_CHEST -> IIdentifier.of("minecraft:diamond_chestplate");
            case IEnchantment.TARGET_ARMOR_HEAD -> IIdentifier.of("minecraft:diamond_helmet");
            case IEnchantment.TARGET_WEAPON -> IIdentifier.of("minecraft:diamond_sword");
            case IEnchantment.TARGET_DIGGER -> IIdentifier.of("minecraft:diamond_pickaxe");
            case IEnchantment.TARGET_FISHING_ROD -> IIdentifier.of("minecraft:fishing_rod");
            case IEnchantment.TARGET_TRIDENT -> IIdentifier.of("minecraft:trident");
            case IEnchantment.TARGET_BOW -> IIdentifier.of("minecraft:bow");
            case IEnchantment.TARGET_CROSSBOW -> IIdentifier.of("minecraft:crossbow");
            case IEnchantment.TARGET_BREAKABLE, IEnchantment.TARGET_VANISHABLE -> IIdentifier.of("minecraft:iron_shovel");
            default -> null;
        };
    }
