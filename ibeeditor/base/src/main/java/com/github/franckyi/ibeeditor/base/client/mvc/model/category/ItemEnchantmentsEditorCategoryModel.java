...
public class ItemEnchantmentsEditorCategoryModel extends ItemEditorCategoryModel {
    ...
    private void addBaseEnchantment(Enchantment enchantment) {
        getEntries().add(new ItemEnchantmentEditorEntryModel(this, enchantment, enchantment.canApply(getEditor().getTarget()),
