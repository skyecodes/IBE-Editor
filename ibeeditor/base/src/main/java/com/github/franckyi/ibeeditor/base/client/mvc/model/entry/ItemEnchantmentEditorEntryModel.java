...
public class ItemEnchantmentEditorEntryModel extends IntegerEditorEntryModel {
    public ItemEnchantmentEditorEntryModel(EditorCategoryModel category, Enchantment enchantment, boolean canApply, int value, Consumer<Integer> action) {
