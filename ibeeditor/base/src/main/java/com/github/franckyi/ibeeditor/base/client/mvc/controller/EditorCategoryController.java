...
public class EditorCategoryController extends AbstractController<EditorCategoryModel, EditorCategoryView> {
    public EditorCategoryController(EditorCategoryModel model, EditorCategoryView view) {
        super(model, view);
    }
