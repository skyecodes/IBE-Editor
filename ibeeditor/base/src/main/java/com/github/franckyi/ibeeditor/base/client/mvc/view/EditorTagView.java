...
public class EditorTagView implements View {
    ...
    public EditorTagView(String texture, Text tooltip, Predicate<String> validator) {
        this(texture, tooltip);
        this.validator = validator;
    }

    public EditorTagView(String texture, Text tooltip) {
